(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === 'object') exports['VueCal'] = factory();
  else root['VueCal'] = factory();
  ...
  return /******/ (function(modules) {
    ...
    __webpack_require__.p = i[1] // eslint-disable-line
      ...
      /***/ '5357': /***/ function(module, __webpack_exports__, __webpack_require__) {
        'use strict';
        /* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_lib_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_App_vue_vue_type_style_index_0_id_c450f74a_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          'edea'
        );
        /* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_lib_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_App_vue_vue_type_style_index_0_id_c450f74a_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/ __webpack_require__.n(
          _node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_lib_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_App_vue_vue_type_style_index_0_id_c450f74a_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__
        );
        /* unused harmony reexport * */
        /* unused harmony default export */ var _unused_webpack_default_export =
          _node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_lib_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_App_vue_vue_type_style_index_0_id_c450f74a_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default.a;
  ...
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
      ...
      /***/ edea: /***/ function(module, exports, __webpack_require__) {
      ...
      /***/ fb15: /***/ function(module, __webpack_exports__, __webpack_require__) {
          ...
          return _c('section', {staticClass: 'container'}, [
            _c(
              'div',
              {
                ...
                staticStyle: {display: "block background-color: 'transparent'"},
                style:
                  _vm.monthlyState.phase === 'dragging' || _vm.dailyState.phase === 'dragging'
                    ? {pointerEvents: 'none', transition: 'none', cursor: '-webkit-grab'}
                    : {},
              },
              [
                    ...
                    _vm._l(_vm.calendar.months, function(month) {
                      return _c(
                        'div',
                        {
                          ...
                          class: month.past ? 'past' : '',
                          attrs: {'month-id': month.fullYear + '-' + month.monthNumber},
                          on: {
                            click: function($event) {
                              _vm.toggleSelectMonth($event, month);
                            },
                          },
                        },
                        [
                          _c('div', {staticClass: 'date-formatted'}, [
                            _c('span', {staticClass: 'cell-content month-name'}, [
                              _vm._v(_vm._s(_vm._f('abr')(_vm.MONTHS[month.monthNumber]))),
                            ]),
                            _vm._v(' ' + _vm._s(month.fullYear % 1000) + '\n          '),
                          ]),
                        ]
                      );
                    })
                ...
                _c('div', {staticClass: 'wrapper'}, [
                  _c(
                    'div',
                    {
                      staticClass: 'calendar ui-draggable',
                      staticStyle: {left: '0px'},
                      style:
                        _vm.dailyState.phase === 'dragging'
                          ? {pointerEvents: 'none', transition: 'none', cursor: '-webkit-grab'}
                          : {},
                      attrs: {id: 'daily'},
                      on: {
                    ...
                    _vm._l(_vm.calendar.days, function(day) {
                      return _c(
                        'div',
                        {
                          ...
                          attrs: {
                            id: day.fullYear + '-' + day.monthNumber + '-' + day.day,
                            month: day.monthNumber,
                            year: day.fullYear,
                          },
                          on: {
                            click: function($event) {
                              _vm.toggleSelect($event, day);
                            },
                          },
                        },
                        [
                ...
                _c('div', {
                  ...
                  style: {visibility: _vm.dailyState.realOffset === 0 ? 'hidden' : 'visible'},
                  on: {
                    click: function($event) {
                      _vm.goLeft($event);
                    },
                ...
                _c('div', {
                  ...
                  style: {
                    visibility:
                      _vm.dailyState.realOffset <= _vm.dailyState.maxOffset ? 'hidden' : 'visible',
                  },
                  on: {
                    click: function($event) {
                      _vm.goRight($event);
        ...
        // CONCATENATED MODULE: ./src/App.vue?vue&type=template&id=c450f74a&scoped=true&
        ...
        function buildCalendar(NUMBER_OF_DAYS, NUMBER_OF_MONTHS, PREPEND_MONTHS) {
          ...
          var calendar = {
            ...
            months: _toConsumableArray(createPrependArray(PREPEND_MONTHS)).concat(
              _toConsumableArray(createMonthsArray(NUMBER_OF_MONTHS))
            ),
          };
          return calendar;
        }
        ...
        /* harmony default export */ var Appvue_type_script_lang_js_ = {
          ...
          methods: {
            goLeft: function goLeft(e) {
              ...
              this.dailyState.realOffset =
                this.dailyState.realOffset + Math.floor(elem.clientWidth / 111) * 111;
              if (this.dailyState.realOffset > 0) this.dailyState.realOffset = 0;
              document.querySelector('#daily').style.left = ''.concat(
                this.dailyState.realOffset,
                'px'
              );
              this.currentMonth;
            ...
            goRight: function goRight(e) {
              ...
              this.dailyState.realOffset =
                this.dailyState.realOffset - Math.floor(elem.clientWidth / 111) * 111;
              if (this.dailyState.realOffset < this.dailyState.maxOffset)
                this.dailyState.realOffset = this.dailyState.maxOffset;
              document.querySelector('#daily').style.left = ''.concat(
                this.dailyState.realOffset,
                'px'
              );
            ...
            handleDrag: function handleDrag(e) {
              ...
              if (e.type === 'mousemove' || e.type === 'touchmove') {
                ...
                state.style.left =
                  state.realOffset <= 0 ? ''.concat(state.realOffset, 'px') : '0px';
                this.currentMonth;
              }
            },
            toggleSelectMonth: function toggleSelectMonth(e, month) {
              ...
              document
                .querySelector(
                  '[month-id="'.concat(month.fullYear, '-').concat(month.monthNumber, '"]')
                )
              ...
              if (e) {
                var id = '[year="'
                  .concat(month.fullYear, '"][month="')
                  .concat(month.monthNumber, '"].cal-cell');
            ...
            scrollIntoView: function scrollIntoView(element) {
              ...
              var offset =
                cal.offsetLeft - cal.parentNode.parentNode.clientWidth * 0.3 - cal.clientWidth;
          ...
          mounted: function mounted() {
            ...
            this.dailyState.monthBreakPoints = _toConsumableArray(
        ...
        // EXTERNAL MODULE: ./src/App.vue?vue&type=style&index=0&id=c450f74a&lang=scss&scoped=true&
        var Appvue_type_style_index_0_id_c450f74a_lang_scss_scoped_true_ = __webpack_require__(
          '5357'
        );
